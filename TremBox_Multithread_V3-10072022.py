...
class Worker(QObject):
    ...
    def dataSendLoop(self,addData_callbackFunc,addData_callbackFunc_Y,addData_callbackFunc_Z, timeOut=10000):
...
if __name__== '__main__':
    ...
    #Increase thread switch performance, default is 100 
